...
std::string input_file_name = "../../input-files/022994/022994.root";
...
{        
        ...
        TNtuple* ntuple_elastics = new TNtuple("ntuple_elastics","","ahdc_trackid:ahdc_kftrackid:ahdc_component:ahdc_layer:ahdc_superlayer:ahdc_sumadc:ahdc_leadingEdgeTime:ahdc_timeOverThreshold:ahdc_kftrackdedx:ahdc_kftrackpath:ahdc_adc_layer:electron_pt:Q2:W:delta_phi");
                        ...
                        for (int j = 0 ; j < n_ahdcrecohits ; j++) {
                                ...
                                for (int k = 0 ; k < nahdcrows ; k++) {
                                        ...
                                        ntuple_elastics->Fill(ahdc_trackid[j], ahdc_kftrackid[i], ahdc_wire[j], ahdc_layer[j], ahdc_superlayer[j],
                                                              ...
                                                              ahdc_kftrackpath[i], ahdc_adc_layer[k], p_electron->Pt(), Q2, W, p_electron->DeltaPhi(*p_kftrack) * TMath::RadToDeg());
                                }
                        }
                }
